...
class PaththuppattuFragment : Fragment(), BookItemClickListener, ActionListener {

    private val RC_READ_WRITE_STORAGE = 1111
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        ppCategoryAdapter = CategoryListAdapter(activity?.applicationContext, ArrayList(), this)
        ...
        rvVerticalItem.adapter = ppCategoryAdapter
        initApi()
        return view
    }
    ...
    private fun initApi() {
        ...
        paththuppattuCall.subscribeOn(Schedulers.io())
                ...
                .subscribe({ result ->
                    ...
                    ppCategoryAdapter.setItems(tmpBookList)
                }, {
    ...
    companion object {
        ...
        fun newInstance(page: Int): PaththuppattuFragment {
            val args = Bundle()
            args.putInt(ARG_PAGE, page)
            val fragment = PaththuppattuFragment()
            ...
            for (booksIt in tmpBookList) {
                for (books in booksIt.books) {
                    if (books.book_id == titleID[1]) {
                        ...
                        ppCategoryAdapter.updateItemStatus(tmpBookList[horizPosition].books[itemPosition], horizPosition, itemPosition)
