...
class PathinenKizkanakkuFragment : Fragment(), BookItemClickListener, ActionListener {
    ...
    private fun initApi() {
        ...
        val pathinenCall = SEAppUtil.getRetrofit().getPathinenkilkanakku()
        pathinenCall.subscribeOn(Schedulers.io())
    ...
    companion object {
        ...
        fun newInstance(page: Int): PathinenKizkanakkuFragment {
            val args = Bundle()
            args.putInt(ARG_PAGE, page)
            val fragment = PathinenKizkanakkuFragment()
