...
class PathinenKizkanakkuFragment : Fragment(), CategoryItemClickListener {
    ...
    private fun initApi() {
        ...
        disposable = pathinenCall.subscribeOn(Schedulers.io())
    ...
    companion object {
        ...
        fun newInstance(): PathinenKizkanakkuFragment {
            return PathinenKizkanakkuFragment()
        }
    }
}